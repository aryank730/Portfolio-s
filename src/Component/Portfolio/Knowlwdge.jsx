        ...
        <>
            <div className=" bg-gradient-to-b from-[#10111D] to-[#655b91] min-h-[90vh] flex items-center relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full">
                    ...
                    <svg className="absolute bottom-0 left-0 text-pink-500/20 w-1/4" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="absolute -top-40 -right-40 w-80 h-auto rounded-full bg-gradient-to-r from-pink-500 to-purple-500 opacity-30 blur-3xl" />
                <div className="absolute -bottom-20 -left-20 w-80 h-auto rounded-full bg-gradient-to-r from-blue-500 to-teal-500 opacity-30 blur-3xl" />
                <div className="container mx-auto px-4 max-w-6xl relative z-10">
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="md:w-1/2 space-y-8">
                            <div className="inline-block">
                                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium text-white">
                                    <div className="w-2 h-2 bg-purple-500 rounded-full" />
                                    <span className="uppercase tracking-widest">Development • Design • Innovation</span>
                                </div>
                            </div>
                            <h1 className="text-4xl sm:text-6xl font-bold text-white leading-tight">
                                ...
                                <span className="relative">
                                    <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-slate-500 to-purple-500 border-b-4 border-pink-500/50">

                                        memorable

                                    </span>
                                    <svg className="absolute -bottom-2 left-0 w-full h-4 text-pink-500/30" viewBox="0 0 150 20">
                                        <path d="M0,20 Q37.5,0 75,20 T150,20" fill="none" stroke="currentColor" strokeWidth="8" />
                                    </svg>
                                </span>
                                <br />
                                experiences
                            ...
                            <div className="relative z-10">
                                <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                                    <div className="aspect-[4/4] bg-gradient-to-br from-gray-900 via-gray-800 to-black">
                                            ...
                                            <div className="w-fit px-4 flex flex-wrap gap-5">
                                                ...
                                                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg text-center">
                                                    <div className="text-purple-500 mb-1">
                                                        <svg viewBox="0 0 248 31" class="w-auto h-5 text-white ">
                                                    ...
                                                    {/* <div className="font-medium text-white text-sm">Creativity</div> */}
                                                </div>
                                                {/* </div> */}
                                        ...
                                        <div className="absolute bottom-1/4 right-10 w-4 h-4 border border-white/20 rounded-sm animate-pulse opacity-30 delay-700" />
                                        <div className="absolute top-1/3 right-1/4 w-6 h-6 border border-white/20 rounded-md animate-pulse opacity-40 delay-500" />
                                    </div>
                                </div>
                                <div className="absolute -top-4 -right-4 p-2 rounded-full bg-black shadow-lg">
                                    <div className="w-14 h-14 bg-gradient-to-br from-[#10111D] to-[#655b91] rounded-full flex items-center justify-center">
                                        <svg width="100" height="40" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round">
                                            <polyline points="35,25 15,50 35,75" />
                                            <polyline points="65,25 85,50 65,75" />
                                            <line x1="55" y1="15" x2="45" y2="85" />
                                        </svg>
                                    </div>
                                </div>
                            </div>
                            <div className="absolute -z-10 top-10 right-10 w-full h-full border-8 border-pink-500/20 rounded-2xl" />
                        </div>
                    </div>
                    <div className="mt-16 py-6 flex justify-center gap-x-12 gap-y-4 flex-wrap border-t border-gray-800">
