  ...
  return (
    <div><section className="w-full py-12  flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#10111D] to-[#655b91]">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        >
          We Make{" "}
          <span className="relative whitespace-nowrap text-[#a69eca] dark:text-green-400">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
            ...
            <span className="relative ">Crafting Scalable Web Apps</span>
          </span>{" "}
           with MERN Stack
        </div>
        <p className="mx-auto mb-8 max-w-2xl text-lg">
          Professional, fast, responsive, and scalable web apps using MongoDB, Express, React, and Node. Clean code. Solid architecture. Real results.
        </p>
        {/* CTA Button */}

        <div className="w-[90%] md:w-[25%] m-auto">
          <Email />
        </div>
