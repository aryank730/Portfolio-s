      ...
      <div className="grid grid-cols-1 md:grid-cols-3 items-center  justify-center flex-col sm:flex-row gap-4 p-4 n bg-slate-1000 dark:bg-slate-900 ">
            ...
            <div className="mt-0 sm:mt-0 lg:mt-14">
              <div className="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p className="text-sm  text-white">
                  An Ecommerce project with admin panel , where login  , register page also add product , delete product and all ecommerce features  are there, by click on  link you can  access my github project lorem34
        ...
        >
          ...
          <div className="relative p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-0 sm:mt-96 lg:mt-14">
              <div className="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p className="text-sm text-white">
...
export const AppTemp = () => {
  return (
    <>
      <div className="m-4 py-6 dark:bg-slate-900">
        ...
        <div className="flex flex-col justify-center space-y-5 md:flex-row md:space-y-0 md:space-x-6 lg:space-x-10 mt-7 mb-8">
          <div className="relative md:w-5/12">
            ...
            <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
              ...
              <button className="w-full px-6 py-3 text-xs text-white transition duration-300 ease-in-out transform border  rounded-full lg:text-md focus:outline-none hover:scale-110 font-medium">
                Go to Docs
              </button>
            </div>
          </div>
          <div className="relative md:w-5/12">
            ...
            <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
              ...
              <button className="w-full px-6 py-3 text-xs text-white transition duration-300 ease-in-out transform bg-indigo-500 border-indigo-400 border  rounded-full lg:text-md focus:outline-none hover:scale-110 font-medium">
                Go to Website
              </button>
            </div>
          </div>
