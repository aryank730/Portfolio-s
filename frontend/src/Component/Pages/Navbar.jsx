...
export default function Navbar() {
  ...
  const navItems = [
    // { path: '/', label: 'Home' },
    // { path: '/', label: 'Portfolio', scrollTo: 'work' },
    // { path: '/aplayground', label: 'Playground' },
  ];

  // "Portfolio" doesn't have its own route - it scrolls to the projects
  // section on the home page. If we're already home, scroll directly;
  // if we're on another page, let NavLink navigate home first, then scroll.
            ...
            <div className="p-4 space-y-2">
              {navItems.map((item) => (
                ...
                >
                  ...
                  <MdKeyboardDoubleArrowRight className="w-5 h-5 text-gray-400 transition-transform duration-300 group-hover:translate-x-1" />
                </NavLink>
              ))}
            </div>
